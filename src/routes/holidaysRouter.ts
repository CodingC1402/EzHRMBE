...
export const UPDATE_PATH: string = "/:name";
export const DELETE_PATH: string = "/:name";
export const GET_PATH: string = "/:name";
...
router.get(GET_PATH, HolidayController.getHolidayByName);
